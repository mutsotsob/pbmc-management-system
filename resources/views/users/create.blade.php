                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name') }}"
                            class="w-full rounded-lg border px-4 py-2.5 text-sm bg-white" placeholder="Full name">
                        @error('name')
                    ...
                    <div>
                        ...
                        <input type="email" name="email" value="{{ old('email') }}"
                            class="w-full rounded-lg border px-4 py-2.5 text-sm bg-white" placeholder="user@example.com">
                        @error('email')
                            <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <select name="user_type" class="w-full rounded-lg border px-4 py-2.5 text-sm bg-white">
                            <option value="user" {{ old('user_type', 'user') === 'user' ? 'selected' : '' }}>User
                            </option>
                        ...
                        <select name="department" class="w-full rounded-lg border px-4 py-2.5 text-sm bg-white">
                            ...
                            @foreach (config('departments') as $dept)
                                <option value="{{ $dept }}" {{ old('department') === $dept ? 'selected' : '' }}>
                                    {{ $dept }}{{ $dept === 'Administration' ? ' (Drivers)' : '' }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <input type="text" name="job_title" value="{{ old('job_title') }}"
                            class="w-full rounded-lg border px-4 py-2.5 text-sm bg-white" placeholder="e.g. Lab Manager">
                        @error('job_title')
                            <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <label class="inline-flex items-center gap-2">
                            <input type="checkbox" name="user_status" value="1"
                                {{ old('user_status', '1') ? 'checked' : '' }} class="rounded border-gray-300">
                    ...
                    <div>
                        ...
                        <input type="password" name="password" class="w-full rounded-lg border px-4 py-2.5 text-sm bg-white"
                    ...
                    <div>
                        ...
                        <input type="password" name="password_confirmation"
                            class="w-full rounded-lg border px-4 py-2.5 text-sm bg-white" placeholder="Repeat password">
                    </div>
                </div>
